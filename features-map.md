...
| FEAT-FILE-BROWSER | File Browser | CRUD | استعراض ملفات الصوت والفيديو مع السحب والإفلات | User | FR-01 | ui/file-browser | P0 | Planned |
| FEAT-FFMPEG-EXEC | FFmpeg Execution | Workflow | تنفيذ أوامر ffmpeg وإدارة حالة التنفيذ | User | FR-02 | core/ffmpeg | P0 | Planned |
